pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/mitchepc'                                                                    //<------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/mitchepc-del/225-lab3-5.git'                                          //<------change this
        KUBECONFIG = credentials('mitchepc-225')                                                         //<------change this
    }
